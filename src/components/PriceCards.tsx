  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background: 'radial-gradient(circle at var(--mouse-x) var(--mouse-y), rgba(245, 158, 11, 0.15), transparent 50%)',
        }}
        animate={isHovered ? {
      ...
      >
        ...
        {/* Button hover effect */}
        <motion.div
          className={`absolute inset-0 ${pkg.popular ? 'bg-white' : 'bg-amber-500'}`}
          initial={{ x: '-100%' }}
          whileHover={{ x: 0 }}
          transition={{ duration: 0.3 }}
        />
