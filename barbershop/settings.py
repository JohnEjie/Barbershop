...
# 👇 update this for Render
ALLOWED_HOSTS = ['barbershop-7zc9.onrender.com', 'localhost', '127.0.0.1']
...
# Optional: If you use PostgreSQL on Render
...
CSRF_TRUSTED_ORIGINS = [
    "http://localhost:5173",
    "http://127.0.0.1:5173",
    "https://barbershop.onrender.com",  # 👈 add your Render domain
]
